...
const PropertyCard: React.FC<PropertyCardProps> = ({
  ...
  return (
    <div className="w-full h-full bg-white shadow-md border rounded-3xl p-4">
      ...
      {/* Features section */}
      <div className="bg-[#F9FAFB] py-6 rounded-sm grid grid-cols-2 gap-3 sm:grid-cols-4 text-center text-sm text-[#03442C] mt-4">
