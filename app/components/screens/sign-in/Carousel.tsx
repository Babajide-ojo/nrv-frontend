...
export default function RentalManagement() {
  ...
  return (
    <div className="font-jakarta  relative bg-green-900 text-white py-16 px-6 sm:px-12 lg:px-24 flex flex-col justify-between  h-screen overflow-y-scroll hide-scrollbar">
      {/* Background Image */}
      ...
      >
        <div className="bg-[#BBFF3733] backdrop-blur-md p-6 rounded-xl shadow-lg">
          <div>
            <p className="text-[16px] leading-8 italic">
