...
type SupportContactPanelProps = {
  /** When true, hide public back-link and tighten padding for dashboard chrome. */
  embedded?: boolean;
};
      ...
      <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
        <section className="rounded-2xl border border-[#D7E6D8] bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-600">
            Send a message and we will reply to your email during operating
          ...
          {sent ? (
            <div className="mt-8 rounded-xl border border-emerald-200 bg-emerald-50 p-6">
              ...
              <p className="mt-1 text-sm text-gray-700">
                Thanks{name ? `, ${name.split(" ")[0]}` : ""}. We sent a
                confirmation to {email || "your email"} and will follow up
        ...
        <aside className="space-y-4">
          <div className="rounded-2xl border border-[#D7E6D8] bg-white p-6">
            <Mail
              className="h-9 w-9 rounded-lg bg-[#045D23] p-2 text-white"
              aria-hidden="true"
            />
            ...
            <ul className="mt-3 space-y-2 text-sm leading-6 text-gray-600">
              ...
              <li>You get an automated confirmation email right away.</li>
              <li>
                We reply to the email address you provide during operating
                hours.
              </li>
              <li>
                Include your account email if you already have an account.
              </li>
            </ul>
          </div>
          <div className="rounded-2xl bg-[#03442C] p-6 text-white">
            <Clock
              className="h-9 w-9 rounded-lg bg-white/15 p-2"
              aria-hidden="true"
            />
