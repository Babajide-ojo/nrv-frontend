...
import { getApplicationsById } from "@/redux/slices/propertySlice";
...
if (!application) return <div className="p-4">Loading application details...</div>;
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-1/3 bg-white rounded-md p-4">
          ...
          <div className="text-center">
            <img src="/images/verified-user-icon.svg" alt="Profile" className="w-48 h-48 mx-auto rounded-full" />
            <div className="text-green-700 text-xs font-medium mt-1">Account Verified</div>
            <div className="text-md font-semibold mt-1">{application?.applicant?.firstName} {application?.applicant?.lastName}</div>
        ...
        <div className="w-full md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <InfoCard title="Employment Details" data={[
            ...
            ['Monthly Income', application?.monthlyIncome.toLocaleString() + " NGN"]
          ]} />
