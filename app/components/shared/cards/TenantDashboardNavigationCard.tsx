...
const TenantDashboardNavigationCard: React.FC<OnboardingCardProps> = ({
  ...
  return (
    <div className="w-full md:h-44 h-30 bg-white border border-nrvLightGray rounded-2xl m-1 p-2 cursor-pointer relative overflow-hidden  flex flex-col justify-end p-4">
