  ...
  return (
    <div className="sticky bg-white">
      ...
      <div className="relative z-10 p-2 md:p-12">
        ...
        <div className="flex p-4 flex-col sm:flex-row text-left">
          <p className="text-white font-medium text-xl sm:text-2xl mt-2 sm:mt-0 sm:w-3/5 landing-body">
    ...
    <div className="bg-white md:p-12 p-4 sm:p-6 mx-auto mt-4 w-full max-w-[1400px] px-4 sm:px-6 text-left">
      <div className="flex flex-col md:flex-row gap-6 md:gap-0">
        ...
        <div className="md:w-7/12 w-full pt-2 md:pt-0">
          <div className="text-[#03442C] text-base sm:text-lg md:text-3xl md:pb-8 landing-heading-2">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-end flex-1 min-h-0 px-4 sm:px-6 md:px-8 pb-6 sm:pb-8 md:pb-8 shrink-0">
          ...
          <div className="md:w-full md:flex block gap-3 sm:gap-4 md:items-end">
            <div className="md:w-2/3 w-full md:text-right">
              <h1 className="text-white font-bold text-[28px] xs:text-[32px] sm:text-[36px] md:text-[60px] pl-0 md:pl-8 landing-heading-1">
                <span className="block">Find Trustworthy Tenants</span>
                <span className="block italic mt-1 md:mt-2 text-[#BBFF37] font-semibold md:font-bold md:text-inherit md:text-white">
                  No More Guesswork!
                </span>
              </h1>
            </div>
            <div className="md:w-1/3 px-0 py-4 sm:py-5 md:p-8 w-full mr-0 md:mr-20 max-w-xl md:text-right">
