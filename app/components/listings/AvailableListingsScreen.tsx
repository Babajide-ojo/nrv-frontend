...
export function AvailableListingsScreen({
  variant = "dashboard",
}: {
  variant?: AvailableListingsVariant;
}) {
  ...
  const subtitle =
    variant === "public"
      ? "Browse available rooms and apartments. Sign in or create an account to apply."
      ...
      <div className="mx-auto max-w-7xl px-2 py-3 sm:px-4 sm:py-5 md:px-6 lg:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-nrvLightGrey text-sm mt-1">{subtitle}</p>
          </div>
          <Btn
            variant="outline"
            size="sm"
        ...
        <section className="rounded-2xl border border-gray-200 bg-white shadow-sm p-5 sm:p-6 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Find your perfect home</h2>
        ...
        {isListLoading ? (
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-10 text-center">
            ...
            <Btn variant="outline" size="sm" className="mt-4" onClick={handleClearFilters}>
              Clear filters
            </Btn>
          </div>
        ) : (
