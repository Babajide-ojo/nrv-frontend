      ...
      <ProtectedRoute>
        <LandLordLayout>
          ...
          {showEditProperty && (
            <div
              id="overlay"
              className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-40 z-50 flex justify-center items-center pt-20"
            >
              <div className="overflow-y-scroll bg-white w-4/5 p-4 relative mt-12  rounded-t-3xl">
                <button
                  className="absolute top-2 right-2 bg-red-500 text-xs text-white rounded-full px-2.5 py-1.5"
                  onClick={() => {
