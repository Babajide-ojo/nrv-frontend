        ...
        <div className="p-4 bg-[#E9F4E7] rounded-sm flex items-center justify-between gap-8">
          <div>
            ...
            <div className="flex gap-8 mt-4">
              ...
              <button className="text-[#045D23] text-sm font-medium flex items-center">
                Complete Setup →
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-sm mt-2 font-light text-[#475367]">
                Verify your tenants with ease.
              </div>
            </div>
          </div>
          <button className="px-3 py-1 text-sm border border-1 text-[#03442C] rounded-lg">
            Proceed
          </button>
        </div>
      </div>
